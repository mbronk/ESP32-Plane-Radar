...
void initLabelMetrics() {
  ...
  if (displayFontIsSmooth()) {
    // Whatever font the weather screen last left active on `tft` is
    // irrelevant here -- force the real smooth body font (with its real
    // metrics) to be loaded before calibrating sizes against it.
